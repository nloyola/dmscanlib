...
private:
   void generateWells();
   void decodeImage(std::vector<std::unique_ptr<const WellRectangle> > & wells,
...
ImageInfoTool::ImageInfoTool(const std::string & _filename,
                             Orientation _orientation,
                             BarcodePosition _position,
                             const PalletSize _palletSize,
                             const bool _decode) :
...
void ImageInfoTool::decodeImage(std::vector<std::unique_ptr<const WellRectangle> > & wellRects,
                                std::map<std::string, std::string> & decodedMessages) {
